...
def plot(epochs = [], train_loss = [], eval_loss = [], eval_precision = [], eval_recall = [], eval_f5 = [], name = ""):
    upper_name = name.upper()
    upper_name = "DistilBERT"
    # Create plots
...
# plot(epochs3, train_loss3, eval_loss3, eval_precision3, eval_recall3, eval_f53, name3)
